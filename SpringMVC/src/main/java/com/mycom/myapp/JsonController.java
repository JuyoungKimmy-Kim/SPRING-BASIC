...
public class JsonController {
	...
	public List<EmpDto> m4 () {
		...
		EmpDto empDto1=new EmpDto (2000,"길동4", "홍4", "hong4@gildong.com", "2022-10-23");
		EmpDto empDto2=new EmpDto (3000,"길동5", "홍5", "hong5@gildong.com", "2022-10-23");
		EmpDto empDto3=new EmpDto (4000,"길동6", "홍6", "hong6@gildong.com", "2022-10-23");
